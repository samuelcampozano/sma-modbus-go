...
// Sentinel values used by SMA to represent NaN, open-circuit, or unmeasured channels.
const (
...
// Returns (value, true) if valid, or (0, false) if the register is invalid or equal to the SMA sentinel.
...
// Returns (value, true) if valid, or (0, false) if the registers are invalid or equal to the SMA sentinel.
...
// DecodeOperatingStatus translates an SMA status code into a descriptive string.
